<link media="all" href="plugins/theme/css/pos.css?1.01" rev="stylesheet" rel="stylesheet">
<section class="content-header">
    <div class="row">
        <div class="col-md-5 operations-btn">
            <div class="box">
                <div class="row">
                    ...
                    <div class="col-md-6 operation-filter-one">
                    ...
                    <div class="col-md-12 cart-table-info">
                    ...
                    <div class="col-md-12 operation-search">
                    ...
                    <div class="col-md-6 operation-filter-four">
                        <div class="form-group has-feedback">
                            <span class="fa fa-sort-numeric-asc form-control-feedback color"></span>
                            <input id="code" type="text" class="form-control" name="code" placeholder="Return Code">
                        </div>
                    </div>
        ...
        <div class="col-md-7 category-list">
            <div class="pos-tab-container">
                <div class="col-md-2 pos-tab-menu">
                    <div class="list-group">
                        <a class="list-group-item active text-center">
                            <i class="fa fa-file-text-o fa-2x color"></i><br/><?php echo $this->lang->line('all'); ?> <small>[F12]</small>
                        </a>
                        <a class="list-group-item text-center">
                            <i class="fa fa-sitemap fa-2x color"></i><br/><?php echo $this->lang->line('category'); ?>
                        </a>
                        <a class="list-group-item text-center">
                            <i class="fa fa-thumb-tack fa-2x color"></i><br/><?php echo $this->lang->line('pins'); ?>
                        </a>
                    </div>
                ...
                <div class="col-md-10 pos-tab">
                    <!-- All Products -->
                    <div class="col-md-12 pos-tab-content all_recode active">
                        <div class="col-md-6 all-search">
                            <input placeholder="<?php echo $this->lang->line('search_me'); ?>" id="input_all" type="text" class="form-control"/>
                        </div>
                        <div class="all-products">
                            <div class="col-md-6 all-pagination">
                    ...
                    <!-- Category Products -->
                    <div class="pos-tab-content category">
                        <div class="col-md-6 all-search">
                                        ...
                                        <div class="tab-pane fade in active" id="pro_tab_all">
                                            ...
                                            if (!empty($extra['category'])) {
                                                foreach ($extra['category'] as $key => $value) {
                                                    ...
                                                    echo "<div class='col-md-2' data-toggle='tab' tabindex='-1' href='#pro_tab_{$cat}'><div class='col-md-12 thumbnail text-center'><img  class='img-responsive' src='images/default.jpg'><div class='caption'><p class='opration-pos-name'><br>{$value['product_category']}</p></div></div></div>";
                                                }
                                            }
                                            ?>
                                        </div>
                    ...
                    <!-- Pin Products -->
                    <div class="pos-tab-content pins">
                        <div class="col-md-6 all-search">
                            <input placeholder="Search Me" id="input_all" type="text" class="form-control"/>
                        </div>
                        <div class="all-products">
...
function add_payment(type){
    ...
    if (type==2) {
        if (window.customer_auto_id!='0') {
            window.chaque           += tender;
            $('.chaque_total').html(to_currency(window.chaque));
        }else{
            simple_alert(4,'<?php echo $this->lang->line('customer_module'); ?>','<?php echo $this->lang->line('please_select_a_customer'); ?>');
        }
    }else if(type==3){
        window.card             += tender;
...
$('.all_recode #input_all').keyup(function(){
   var valThis = $(this).val().toLowerCase();
    if(valThis == ""){
        $('.all_recode > div .col-md-2').show();
    } else {
        $('.all_recode > div .col-md-2').each(function(){
...
$('.category #input_all').keyup(function(){
   var valThis = $(this).val().toLowerCase();
    if(valThis == ""){
        $('.category > div .col-md-2').show();
    } else {
        $('.category > div .col-md-2').each(function(){
            var text = $(this).text().toLowerCase();
            (text.indexOf(valThis) >= 0) ? $(this).show() : $(this).hide();
        });
   };
...
$('.pins #input_all').keyup(function(){
   var valThis = $(this).val().toLowerCase();
    if(valThis == ""){
        $('.pins > div .col-md-2').show();
    } else {
        $('.pins > div .col-md-2').each(function(){
            var text = $(this).text().toLowerCase();
            (text.indexOf(valThis) >= 0) ? $(this).show() : $(this).hide();
        });
   };
...
function quick_pay(type,is_print) {
    ...
    if (window.total) {
        $.ajax({
            type: 'POST',
            dataType: 'json',
            data:{'pay_type':type,'sales_auto_id':window.sales_auto_id,'sub_total':window.sub_total,'item_discount':window.item_discount,'total':window.total,'full_discount':window.full_discount,'tax':window.tax,'cash':window.cash,'chaque':window.chaque,'card':window.card,'gift_card':window.gift_card,'sales_tender':window.sales_tender,'payment_cheque_bank':$('#payment_cheque_bank').val(),'payment_cheque_no':$('#payment_cheque_no').val(),'payment_card_type':$('#payment_card_type').val(),'payment_card_no':$('#payment_card_no').val(),'payment_giftcard_code':$('#payment_giftcard_code').val(),'payment_giftcard_expire':$('#payment_giftcard_expire').val()},
